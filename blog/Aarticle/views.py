...
from Aarticle.models import Article, Comment
from Aarticle.forms import ArticleForm
from main.views import admin_required

@login_required
def Aarticle(request):
    '''
    ...
    return render(request, 'Aarticle/article.html', context)
...
def articleCreate(request):
    ...
    '''
    template = 'Aarticle/articleCreateUpdate.html'
    ...
    return redirect('Aarticle:Aarticle')
...
def articleRead(request, articleId):
    ...
    return render(request, 'Aarticle/articleRead.html',  context)
...
def articleUpdate(request, articleId):
    ...
    return redirect('Aarticle:articleRead', articleId=articleId)
...
def articleSearch(request):
    ...
    return render(request, 'Aarticle/articleSearch.html', context)
...
@login_required
def person(request):
    template = 'Aarticle/person.html'
    return render(request, template)

@login_required
def personarticle(request):
    
    template = 'Aarticle/personarticle.html'
    if request.method == 'GET':
        return render(request, template, {'articleForm':ArticleForm()})
    # POST
